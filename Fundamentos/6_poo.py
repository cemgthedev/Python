...
Detalhes:
  . Alguns paradigmas que existem são: imperativo, funcional, lógico e orientado a objetos
Como diz o nome, é uma forma de programar baseando-se em objetos. Deste modo temos quatro pilares fundamentais de OO:
  ...
  . Herança: extendemos atributos e métodos de uma classe para classes filhas reutilizando código.
...
'''
Exemplificando, suponha que queremos representar clientes e funcionários em um sistema:
Clientes e funcionários são pessoas. Então podemos criar a classe mãe, Pessoa,
de forma que as classes Cliente e Funcionario extenderão herdando atributos e métodos da mesma.
'''
class Pessoa:
...
c = Funcionario("Edu", 21, "12213123123", 4530);
c.informacoes();
