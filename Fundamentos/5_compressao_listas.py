...
'''
Exemplificando, suponha que queremos filtrar apenas os elementos maiores ou iguais a 5 da lista abaixo 
'''
...
'''
Com apenas uma linha e utilizando a mesma lista foi possível fazer a mesma coisa que no trecho de código da linha
9 a 13.
'''
